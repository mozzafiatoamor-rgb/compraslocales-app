...
create policy tickets_public_read on storage.objects for select to anon, authenticated using (bucket_id='tickets');
update storage.buckets set public=true where id='tickets';  -- recibos visibles por URL; subir solo autenticados
